...
public class ClienteController {
    ...
    public ModelAndView dados(Authentication authentication) {
        ...
        try {
            Cliente cliente = clienteService.findAutheticated(authentication);
    ...
    public String creteAgendamento(@RequestParam(name = "servicoId") Long servicoId, @RequestParam(name = "prestadorId") Long prestadorId, @RequestParam(name = "data")LocalDate data, @RequestParam(name = "hora")LocalTime hora, RedirectAttributes attributes, Authentication authentication) {
        try {
    ...
    public String cancelarAgendamento(@RequestParam(name = "agendamentoId") Long agendamentoId,
        ...
        try {
            agendamentoService.cancelAgendaClienbte(authentication, agendamentoId);
