...
public class Agendamento {
    ...
    private Long id;
    @NotNull(message = "O campo de agendamento referente ao cliente não pode ser vazio")
    @ManyToOne
    @JoinColumn(nullable = false)
    private Cliente cliente;
    @NotNull(message = "O campo de agendamento referente ao prestador não pode ser vazio")
    @ManyToOne
    @JoinColumn(nullable = false)
    private Prestador prestador;
    @NotNull(message = "O campo de agendamento referente ao serviço não pode ser vazio")
    @ManyToOne
    @JoinColumn(nullable = false)
