...
public class Prestador extends Usuario {
    ...
    @ManyToMany
    @JoinTable(name = "prestadores_servicos",
    ...
    public Prestador(Long id, String nome, String email, String senha, Perfil perfil, Boolean habilitado, String descricao, Float taxaPorHora, List<Servico> especialidade) {
        super(id, nome, email, senha, perfil, habilitado);
    ...
    public void setEspecialidade(List<Servico> especialidades) {
